...
public class TestConstructor {
    public static void main(String[] args) throws Exception{
        Class<?> personClass = Class.forName("normalTest.demo20211119.Person");        //获取所有的构造函数，包括私有的，不包括父类的
        System.out.println("personClass==="+personClass.getName());
        Constructor<?>[] allConstructors = personClass.getDeclaredConstructors();     //获取所有公有的构造函数，包括父类的
